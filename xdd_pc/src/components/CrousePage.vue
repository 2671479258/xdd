<template>
  ...
  <li @click="category=cat.id" :class="category==cat.id?'this':''" v-for="cat in category_list" :key="cat.id">
    {{cat.name}}
  </li>
</ul>
      ...
      <div class="course-list">
        <div class="course-item" v-for="course in course_list" :key="course.id">
          ...
          <div class="course-info">
            <h3><router-link :to="'/courses/detail/'+course.id">{{course.name}}</router-link> <span><img src="@/assets/image/avatar1.svg" alt="">{{course.students}}人已加入学习</span></h3>
...
<style scoped>
  ...
  .course-item .lesson-list li {
    ...
    background: url("@/assets/image/play-icon-gray.svg") no-repeat left 4px;
    margin-bottom: 15px;
  }
  ...
  .course-item .lesson-list li:hover{
      background-image: url("@/assets/image/play-icon-yellow.svg");
      color: #ffc210;
  }
