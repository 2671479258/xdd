    ...
    <div class="header">
      <div class="content">
        <div class="logo full-left">
          <router-link to="/"><img src="@/assets/image/logo.svg" alt="Logo" height="80px" width="300px"></router-link>
        </div>
        <ul class="nav full-left">
          <li v-for="nav in nav_list" :key="nav.id"> <!-- 假设 nav 对象中有一个 id 属性 -->
        ...
        <div v-if="token" class="login-bar full-right">
            ...
            <div class="login-box login-box1 full-left">
              ...
              <el-menu width="200" class="member el-menu-demo" mode="horizontal">
                  <el-submenu index="2">
                    <template slot="title"><img src="@/assets/image/logo@2x.png" alt=""></template>
  ...
  methods:{
    ...
    get_nav(){
      this.$axios.get(`${this.$settings.HOST}/nav/header/`,{})
        .then(response => {
          console.log(response.data); // 确认数据是否正确
